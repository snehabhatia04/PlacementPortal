...
//   if (
//     ["fpc", "faculty"].includes(user.role) &&
//     newStudent.department !== user.department
//   ) {
//     alert("You can only add students from your own department.");
//     return;
//   }
...
//             <DialogTitle>Add New Student</DialogTitle>
// <DialogContent>
//   {["reg_no", "student_name", "email", "stipend"].map((field) => (
//     <TextField
//       key={field}
//       label={field.replace("_", " ").toUpperCase()}
//       variant="outlined"
...
//     if (["fpc", "faculty"].includes(user.role) && newStudent.department !== user.department) {
//       alert("You can only add students from your own department.");
//       return;
//     }
...
const CompanyPage = () => {
  ...
  const handleAddStudent = async () => {
    ...
    const selectedCode = newStudent.department;
    const fullDept = DepartmentMap[selectedCode] || selectedCode;

    if (
      ["fpc", "faculty"].includes(user.role) &&
      fullDept !== DepartmentMap[user.department]
    ) {
      alert("You can only add students from your own department.");
      return;
    }
